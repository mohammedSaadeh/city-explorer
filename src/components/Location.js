    ...
    render(){
        return(
            <div>
                ...
                <br></br>
                <br></br>
                {this.state.mapFlag && <img src={`https://maps.locationiq.com/v3/staticmap?key=pk.d2d5cb3611372e2e9aa72978f1e420e8&center=${this.state.lat},${this.state.lon}`} alt="map img"/>}
